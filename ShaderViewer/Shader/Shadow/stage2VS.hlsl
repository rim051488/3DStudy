...
VSOutput main( VSInput input )
{
	...
	lWorldNrm.x = dot(input.norm, g_Base.LocalWorldMatrix[ 0 ].xyz ) ;
	lWorldNrm.y = dot(input.norm, g_Base.LocalWorldMatrix[ 1 ].xyz ) ;
	lWorldNrm.z = dot(input.norm, g_Base.LocalWorldMatrix[ 2 ].xyz ) ;
